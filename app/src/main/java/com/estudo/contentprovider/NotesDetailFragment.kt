...
import com.estudo.contentprovider.databse.NotesDatabaseHelper.Companion.DESCRIPTION_NOTES
import com.estudo.contentprovider.databse.NotesDatabaseHelper.Companion.TITLE_NOTES
import com.estudo.contentprovider.databse.NotesProvider.Companion.URI_NOTES
...
class NotesDetailFragment: DialogFragment(), DialogInterface.OnClickListener {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        return AlertDialog.Builder(activity as Activity)
            .setTitle(if (newNote) getString(R.string.alert_title) else getString(R.string.alert_update))
            .setView(view)
            .setPositiveButton(getString(R.string.alert_positive_button), this)
            .setNegativeButton(getString(R.string.alert_negative_button), this)
            .create()
